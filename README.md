Python software that combines two types of games:

1. Stone, paper and scissors - The goal is to beat the computer.
   The first to reach 3 victories is the winner.
   You can make as many games as you want. At the end of each round the status of the wins is displayed.
   You can see your success rate at a click of a button.
